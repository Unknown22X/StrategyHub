...
Live Trading requires a local SQLite Live Readiness Record with separate Paper
...
and risk check. PostgreSQL is not part of the installed product or Paper demo.
