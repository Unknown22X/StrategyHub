...
النتيجة الحالية: **48 اختباراً ناجحاً**. لا تستخدم الاختبارات مفاتيح Gate.io أو
...
- Testnet وLive يعرضان فقط حالة مصالحة منقّحة عبر واجهة محلية. لا تقبل الواجهة
  مفاتيح أو توقيعات أو حمولة Gate.io خام.
...
- نقطة تنفيذ Live محجوبة افتراضياً عندما لا يوجد adapter مهيأ؛ تعيد خطأ آمن ولا
  ترسل طلباً. هذا مقصود لمنع إرسال أمر حقيقي أثناء قبول هذا الإصدار.
