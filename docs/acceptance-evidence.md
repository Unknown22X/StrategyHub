...
النتيجة الحالية: **49 اختباراً ناجحاً**. لا تستخدم الاختبارات مفاتيح Gate.io أو
...
- نقطة تنفيذ Live محجوبة افتراضياً عندما لا يوجد adapter مهيأ؛ تعيد خطأ آمن ولا
  ترسل طلباً. تنفيذ Gate.io v4 الكامل (المصادقة، الأوامر، الحماية، WebSocket
  والمصالحة) ما زال شرطاً مفتوحاً ولا يدّعي هذا الدليل اكتماله.
